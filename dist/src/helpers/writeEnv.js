...
exports.constructEnvFromJson = constructEnvFromJson;
function writeEnv(functionInstance) {
    return __awaiter(this, void 0, void 0, function () {
        var path, env, keys;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    path = "".concat(functionInstance.getInstallationPath(), "/.env");
                    env = "";
                    return [4, constructEnvFromJson(functionInstance)];
                case 1:
                    keys = _a.sent();
