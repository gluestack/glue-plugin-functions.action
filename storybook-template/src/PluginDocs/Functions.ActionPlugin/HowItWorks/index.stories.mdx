...
* ## Instructions to start development of auth plugin instance
  ...
  **action.graphql** file inside which we can define all of our actions for
  hasura engine.

  <br/>

  * We can also set whether to define **sync** action or **async** action
  by going into **action.setting** file.
